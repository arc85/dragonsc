...
expect_max_zero <- function(pca.components,tsne.coordinates,clusters,parameter.estimates,max.iterations,delta.log.li,num.cores) {
...
if (i==1) {
	...
	expectation <-expectation_step_zero(pca.components,clusters,parameter.estimates,num.cores)
